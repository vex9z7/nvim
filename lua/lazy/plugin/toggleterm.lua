return {
    ...
    config = function()
        ...
        if
            ...
            and vim.fn.executable("lazygit") == 1
        then
        ...
        maps.n["<C-'>"] = {
            '<Cmd>execute v:count . "ToggleTerm"<CR>',
            desc = "Toggle terminal",
        } -- requires terminal that supports binding <C-'>
        maps.t["<C-'>"] = { "<Cmd>ToggleTerm<CR>", desc = "Toggle terminal" } -- requires terminal that supports binding <C-'>
        maps.i["<C-'>"] =
            { "<Esc><Cmd>ToggleTerm<CR>", desc = "Toggle terminl" } -- requires terminal that supports binding <C-'>
        -- keymaps from astronvim
